// File: components/ui/LuxuryButtonSkia.tsx
...
export default function LuxuryButtonSkia({
  label,
  onPress,
  disabled = false,
  loading = false,
      ...
      <Canvas style={StyleSheet.absoluteFill}>
        <Group>
          ...
          <RoundedRect
            x={2}
            y={3}
            width={typeof width === 'number' ? Math.max(width - 4, 0) : 0}
          ...
          {/* Reflection sweep for metallic gold */}
          {isGoldFill ? (
            <RoundedRect
              x={0}
              y={0}
          ...
          <RoundedRect
            x={6}
            y={4}
            width={typeof width === 'number' ? Math.max(width - 12, 0) : 0}
            height={height * 0.38}
            r={borderRadius}
          >
            <LinearGradient
          ...
          <RoundedRect
            x={0.8}
            y={0.8}
            width={typeof width === 'number' ? Math.max(width - 1.6, 0) : 0}
          ...
          <RoundedRect
            x={1.5}
            y={1.5}
            width={typeof width === 'number' ? Math.max(width - 3, 0) : 0}
          ...
          <RoundedRect
            ...
            style="stroke"
            strokeWidth={0.7}
            color={isGoldFill ? 'rgba(78,58,31,0.16)' : 'rgba(0,0,0,0.16)'}
          />
        </Group>
      </Canvas>
