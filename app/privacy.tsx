        ...
        >
          ...
          <View style={styles.section}>
            ...
            <LinearGradient colors={['rgba(110,191,139,0.10)', theme.cardGradientEnd]} style={[styles.securityCard, { marginTop: 12 }]}>
              ...
              <Text style={styles.paragraph}>
                Encrypted .msky backups use <Text style={styles.highlight}>AES-256-GCM with PBKDF2-SHA256</Text> key derivation (310,000 iterations) from your chosen passphrase. Backups are never uploaded to any server — you control where they go via your device's share sheet.
              </Text>
            </LinearGradient>
          </View>
