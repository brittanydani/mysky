 ...
 *
 * Full personalized daily guidance, energy weather, moon phases,
 * retrograde awareness, and transit signals.
 *
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        ...
        >
          ...
          {/* ── 11. Why This? (Premium: full, Free: teaser with first signal) ── */}
          {insight && (
            <Animated.View entering={FadeInDown.delay(550).duration(600)} style={styles.section}>
              <Pressable
                onPress={isPremium ? toggleWhyThis : () => router.push('/(tabs)/premium' as Href)}
                accessibilityRole="button"
              ...
              >
                ...
                >
                  <View style={styles.whyThisHeader}>
                    ...
                    {isPremium ? (
                      <Ionicons name={showWhyThis ? 'chevron-up' : 'chevron-down'} size={20} color={theme.textMuted} />
                    ) : (
...
const styles = StyleSheet.create({
  ...
  centeredFlex: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: theme.spacing.xl },
  ...
  navBar: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(201, 169, 98, 0.10)',
  },
  ...
  // ── Loading / empty ──
  loadingText: {
    fontSize: 16, color: theme.textSecondary, textAlign: 'center', marginBottom: theme.spacing.lg, lineHeight: 24,
  },
  emptyTitle: {
    fontSize: 24, fontWeight: '600', color: theme.textPrimary, fontFamily: 'serif',
  ...
  headerText: { flex: 1 },
  favoriteButton: { padding: theme.spacing.sm, marginTop: theme.spacing.xs },
  date: {
    fontSize: 14, color: theme.primary, fontWeight: '600',
    letterSpacing: 1, textTransform: 'uppercase', marginBottom: theme.spacing.sm,
  },
  greeting: { fontSize: 22, color: theme.textPrimary, fontFamily: 'serif', lineHeight: 30 },
  ...
  cosmicWeatherText: { fontSize: 16, color: theme.textPrimary, lineHeight: 24, fontFamily: 'serif' },
  intensityRow: {
    flexDirection: 'row', alignItems: 'center', marginTop: theme.spacing.md,
    paddingTop: theme.spacing.md, borderTopWidth: StyleSheet.hairlineWidth,
  ...
  moonPhaseTextContainer: { flex: 1 },
  moonPhaseName: { color: theme.textPrimary, fontWeight: '600', fontSize: 17 },
  moonPhaseMessage: { color: theme.textSecondary, fontSize: 13, fontStyle: 'italic', marginTop: 2 },
  moonSignRow: {
    flexDirection: 'row', alignItems: 'center', marginTop: theme.spacing.md,
    paddingTop: theme.spacing.md, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)',
  },
  ...
  moonWeekRow: {
    flexDirection: 'row', justifyContent: 'space-between', marginTop: theme.spacing.md,
    paddingTop: theme.spacing.md, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)',
  },
  ...
  retrogradeBanner: {
    ...
    borderColor: 'rgba(224, 176, 122, 0.15)', marginBottom: theme.spacing.sm,
  },
  ...
  yesterdayLabel: {
    ...
    letterSpacing: 0.5, textTransform: 'uppercase', marginLeft: theme.spacing.xs,
  },
  yesterdayText: { fontSize: 14, color: theme.textSecondary, lineHeight: 20 },
  yesterdayHighlight: { color: theme.primary, fontStyle: 'italic' },
  ...
  strongestBadge: {
    marginLeft: 'auto', backgroundColor: 'rgba(201, 169, 98, 0.12)',
  ...
  affirmationCard: {
    ...
    alignItems: 'center' as const, borderWidth: 1, borderColor: 'rgba(201, 169, 98, 0.1)',
  },
  affirmationText: {
    color: theme.primary, fontSize: 16, fontStyle: 'italic' as const,
    fontFamily: 'serif', lineHeight: 24, textAlign: 'center' as const,
  },
  affirmationSource: {
    color: theme.textMuted, fontSize: 11, marginTop: theme.spacing.sm,
  ...
  reminderCard: {
    borderRadius: theme.borderRadius.xl, padding: theme.spacing.xl, borderWidth: 1,
    borderColor: 'rgba(201, 169, 98, 0.2)', alignItems: 'center',
  },
  promptLabel: {
    fontSize: 12, fontWeight: '600', color: theme.textMuted,
    letterSpacing: 1, textTransform: 'uppercase', marginBottom: theme.spacing.md,
  },
  reminderText: {
    fontSize: 16, color: theme.textPrimary, fontStyle: 'italic',
    textAlign: 'center', lineHeight: 26, fontFamily: 'serif',
  },
  journalButton: { borderRadius: theme.borderRadius.lg, overflow: 'hidden' },
  journalGradient: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    paddingVertical: theme.spacing.md, paddingHorizontal: theme.spacing.lg,
  },
  journalButtonText: { fontSize: 15, color: theme.primary, fontWeight: '600', marginLeft: theme.spacing.sm },
  ...
  whyThisTitle: { fontSize: 15, fontWeight: '600', color: theme.primary },
  whyThisTeaser: {
    marginTop: theme.spacing.md, paddingTop: theme.spacing.md,
    borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: 'rgba(255, 255, 255, 0.08)',
  },
  teaserMore: { fontSize: 12, color: theme.primary, fontStyle: 'italic', marginTop: theme.spacing.sm },
  whyThisContent: {
    marginTop: theme.spacing.lg, paddingTop: theme.spacing.lg,
    borderTopWidth: 1, borderTopColor: 'rgba(255, 255, 255, 0.1)',
  },
  timelineSection: { marginBottom: theme.spacing.lg },
  timelineRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: theme.spacing.sm },
  timelineLabel: { fontSize: 14, color: theme.textMuted },
  timelineValue: { fontSize: 14, color: theme.textPrimary, fontWeight: '500' },
  cycleNote: { fontSize: 13, color: theme.textSecondary, fontStyle: 'italic', marginTop: theme.spacing.sm, lineHeight: 20 },
  signalsSection: { gap: theme.spacing.sm },
  signalsSectionTitle: {
    fontSize: 12, color: theme.textMuted, fontWeight: '600',
    letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: theme.spacing.xs,
  },
  signalRow: { flexDirection: 'row', alignItems: 'center', gap: theme.spacing.sm },
  signalDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: theme.primary },
  signalText: { flex: 1, fontSize: 13, color: theme.textSecondary },
  signalOrb: { fontSize: 12, color: theme.textMuted, fontFamily: 'monospace' },
  resonanceSection: {
    marginTop: theme.spacing.md, paddingTop: theme.spacing.md,
    borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: 'rgba(255,255,255,0.06)',
  },
  resonanceLabel: { fontSize: 13, fontWeight: '600' as const, color: theme.textGold, marginBottom: 4 },
