...
const styles = StyleSheet.create({
  ...
  sealIconText: { color: '#C9AE78', fontSize: 20, transform: [{ rotate: '45deg' }] },
  ...
  aiPromptIcon: { color: '#C9AE78', fontSize: 14, marginRight: 6 },
  aiPromptText: { color: '#C9AE78', fontSize: 12, fontWeight: '600' }
});
