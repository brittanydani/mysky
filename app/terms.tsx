      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        ...
        >
          <Animated.View entering={FadeInDown.delay(100).duration(600)}>
            ...
            <Text style={styles.paragraph}>
              Premium access ("Deeper Sky") is available via auto-renewing subscriptions (monthly or yearly). Payment is charged through your platform account at confirmation of purchase. Subscriptions automatically renew unless canceled at least 24 hours before the end of the current period. Your account will be charged for renewal within 24 hours prior to the end of the current period. You can manage or cancel subscriptions in your device's App Store or Google Play subscription settings. Purchases can be restored at any time.
            </Text>
