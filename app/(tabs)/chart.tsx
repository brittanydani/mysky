...
const GLOSSARY: { term: string; definition: string }[] = [
  ...
  { term: 'Midheaven (MC)', definition: 'The highest point of your chart, representing your public image, career path, and life direction. It shows how the world sees your achievements.' },
  { term: 'Descendant (DC)', definition: 'The sign on your 7th house cusp, directly opposite your Ascendant. It reveals what you seek in partnerships and how you relate one-on-one.' },
  { term: 'Imum Coeli (IC)', definition: 'The lowest point of your chart, representing your roots, home life, and private inner world. It shows your emotional foundation.' },
  { term: 'Sextile', definition: 'A supportive 60° angle between two planets. Sextiles represent opportunities that require a little effort to unlock.' },
  { term: 'Quincunx (Inconjunct)', definition: 'An awkward 150° angle between two planets. It creates a nagging sense that two parts of your life don\'t quite fit — requiring constant adjustment.' },
  { term: 'Lilith (Black Moon)', definition: 'A calculated point representing your raw, untamed instincts and the parts of yourself society told you to suppress.' },
  { term: 'Part of Fortune', definition: 'A calculated point blending your Sun, Moon, and Ascendant. It highlights where you find joy, luck, and a natural sense of flow.' },
  { term: 'Vertex', definition: 'A fated point in your chart associated with destined encounters and turning points that feel beyond your control.' },
  { term: 'Chart Ruler', definition: 'The planet that rules your Rising sign. It acts as the CEO of your chart, coloring your entire life approach and motivation.' },
  { term: 'Dominant Planet', definition: 'The planet with the most influence in your chart based on its sign, house, and aspects. It shapes your personality more than any other.' },
  { term: 'Dignity', definition: 'A planet\'s comfort level in its sign. A planet in domicile or exaltation is strong and at ease; in detriment or fall, it must work harder to express itself.' },
  { term: 'Dispositor', definition: 'The planet that rules the sign another planet sits in. Dispositor chains show which planet ultimately "calls the shots" in your chart.' },
  { term: 'Mutual Reception', definition: 'When two planets each sit in the sign the other rules — they support each other like a handshake agreement, strengthening both.' },
  { term: 'Chart Shape', definition: 'The overall pattern formed by your planets around the wheel — like Bowl, Bucket, or Splash. It reveals your broad approach to engaging with the world.' },
  { term: 'Singleton', definition: 'A planet that stands alone in a hemisphere, element, or modality. It carries outsized importance as the sole representative of that energy.' },
  { term: 'Interception', definition: 'When a sign is completely contained within a house without touching a cusp. Intercepted energies can feel hidden or harder to access until consciously developed.' },
  { term: 'Grand Trine', definition: 'Three planets forming an equilateral triangle (all 120° apart). A Grand Trine is a gift of natural talent — but can also lead to complacency.' },
  { term: 'T-Square', definition: 'Two planets in opposition with a third squaring both. A T-Square creates persistent tension that drives ambition and growth through challenge.' },
  { term: 'Yod (Finger of God)', definition: 'Two planets in sextile, both quincunx a third. A Yod creates a sense of fated mission — an urgent, unavoidable calling in the apex planet\'s domain.' },
  { term: 'Grand Cross', definition: 'Four planets forming a cross of two oppositions and four squares. It creates intense pressure from all sides but also extraordinary resilience.' },
  { term: 'Applying vs Separating', definition: 'An applying aspect is still forming and growing stronger. A separating aspect has already peaked and is fading — applying aspects have more influence.' },
  { term: 'Hemisphere Emphasis', definition: 'Which half of your chart holds most planets. Northern = private and inner-focused. Southern = public and outer-focused. Eastern = self-directed. Western = other-oriented.' },
  { term: 'Polarity', definition: 'Signs are either masculine (Fire + Air — active, outward) or feminine (Earth + Water — receptive, inward). Your balance shows your default mode of engaging.' },
];
