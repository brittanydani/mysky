        ...
        >
            ...
            <Animated.View entering={FadeInDown.delay(200).duration(600)} style={styles.chartSummary}>
              ...
              >
                <View style={styles.chartHeader}>
                  <Text style={styles.chartTitle}>Your Personal Map</Text>
          ...
          {!userChart && !loading && (
            <Animated.View entering={FadeInDown.delay(200).duration(600)} style={styles.chartSummary}>
              ...
              >
                <View style={styles.chartHeader}>
                  <Text style={styles.chartTitle}>Start Your Reflection Journey</Text>
...
const styles = StyleSheet.create({
  ...
  signItem: { alignItems: 'center', flex: 1, paddingHorizontal: 2 },
  signLabel: { color: theme.textMuted, fontSize: 11 },
  signValue: { color: theme.textPrimary, fontWeight: '600', fontSize: 12, textAlign: 'center' },
  signElement: { color: theme.primary, fontStyle: 'italic', fontSize: 10 },
