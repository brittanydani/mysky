        ...
        >
          ...
          <View style={[styles.faqCard, styles.velvetBorder]}>
            ...
            <View style={styles.faqContent}>
              ...
              <Text style={styles.answer}>
                Only dream interpretation uses Google Gemini. Free accounts use the standard Gemini model. Deeper Sky subscribers access a richer dream model with more nuanced and contextual responses. Reflection insights are generated by MySky’s local rule-based engines, not AI.
              </Text>
