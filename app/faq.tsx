        ...
        >
          ...
          <View style={[styles.faqCard, styles.velvetBorder]}>
            ...
            <View style={styles.faqContent}>
              ...
              <Text style={styles.answer}>
                MySky uses Google Gemini for dream interpretation and optional AI refinement of selected daily insight cards. Free accounts use the standard model. Deeper Sky subscribers access a richer model with more nuance. Reflection patterns are still selected by MySky's local engines first; AI can refine the wording after that.
              </Text>
              ...
              <Text style={styles.question}>What gets sent to AI for insight refinement?</Text>
              <Text style={styles.answer}>
                MySky sends the selected local insight card, pattern keys, and short evidence snippets so Gemini can refine the language. It does not send your full journal history, birth data, location, email, or account identity. You can turn AI Insight Refinement off in Settings.
              </Text>
              ...
              <Text style={styles.answer}>
                A free account is required because Supabase is the canonical store for your charts, entries, and history. It also enables subscription restoration across devices and gates optional network features such as AI dream interpretation and geocoding.
              </Text>
