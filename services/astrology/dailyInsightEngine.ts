  ...
  Moon: {
    conjunction: {
      Sun: {
        ...
        observation: "You're more aware of what energizes vs. drains you today. Small preferences feel more pronounced.",
        choicePoint: "Honor one thing that sounds genuinely good to you, even if it's small.",
      },
      Moon: {
        title: "Monthly reset point",
        observation: "Emotional patterns from the last month become more visible. You may feel both tender and clear.",
        choicePoint: "Name one feeling that's been building. Let it have space.",
      },
      Venus: {
        title: "Craving sweetness",
        observation: "You'll notice what feels beautiful, comfortable, or connecting. Small pleasures hit harder.",
        choicePoint: "Indulge one sensory comfort without guilt.",
      },
      Mars: {
        title: "Impatience is data",
        observation: "Frustration rises faster, but so does motivation. You'll know what you want to do.",
      ...
      Ascendant: {
        ...
        observation: "You're more aware of how others see you. First impressions and reactions feel amplified.",
        choicePoint: "Show up as you actually are, not as you think you should be.",
      },
      Midheaven: {
        title: "Purpose feels present",
        observation: "Career, reputation, or life direction stirs something in you. What matters feels clearer.",
    ...
    square: {
      Sun: {
        ...
        observation: "What you need and who you think you should be don't quite match today. That tension is useful.",
      ...
      Mars: {
        ...
        observation: "Irritation and impatience may spike. Something wants to move, but obstacles appear.",
      ...
      Ascendant: {
        ...
        observation: "How you see yourself versus how you feel don't align. Minor social friction is possible.",
    ...
    opposition: {
      Sun: {
        title: "Needs vs. ego",
        observation: "What you want emotionally may conflict with how you want to appear. Both are valid.",
        choicePoint: "Honor your needs, even if they feel inconvenient to your image.",
      },
      Moon: {
        title: "Full Moon echo",
        observation: "Something reaches a peak or requires acknowledgment. Emotions are full, not broken.",
      ...
      Ascendant: {
        ...
        observation: "Relationship dynamics are highlighted. What you project and what you receive feel mismatched.",
    ...
    trine: {
      ...
      Venus: {
        ...
        observation: "Connection, beauty, and pleasure feel accessible. Relationships have ease.",
        choicePoint: "Lean into the sweetness. Receive as well as give.",
      },
      Mars: {
        title: "Productive energy",
        observation: "Motivation and emotion align. You can act on what you feel without second-guessing.",
        choicePoint: "Start the thing. The momentum is real.",
      },
      Mercury: {
        title: "Clear communication",
        observation: "Thoughts and feelings translate well. Conversations flow, writing comes easier.",
        choicePoint: "Have the conversation you've been postponing.",
      },
      Ascendant: {
        title: "Showing up naturally",
        observation: "How you feel and how you appear are in sync. People respond well to your presence.",
    ...
    sextile: {
      Sun: {
        ...
        observation: "A gentle sense of knowing who you are and what you need. Nothing dramatic, just solid.",
        choicePoint: "Make one choice that reflects your actual values.",
      },
      Moon: {
        title: "Emotional opportunity",
        observation: "Small openings for processing or connection appear. They're easy to miss if you're busy.",
        choicePoint: "Say yes to the soft invitation—the tea, the call, the pause.",
      },
      Venus: {
        title: "Small pleasures",
        observation: "Beauty and comfort are available if you look for them. Nothing grand, just nice.",
        choicePoint: "Notice one thing that's genuinely lovely in your day.",
      },
      Mars: {
        title: "Gentle momentum",
        observation: "Energy is available without pressure. You can act, but you don't have to push.",
  ...
  Venus: {
    conjunction: {
      Venus: {
        ...
        observation: "Your relationship and aesthetic preferences feel more defined. You know what you like.",
        choicePoint: "Invest in something beautiful or meaningful to you.",
      },
      Mars: {
        title: "Attraction is active",
        observation: "Desire and affection blend. You may feel drawn to pursue what (or who) you want.",
    ...
    square: {
      Venus: {
        ...
        observation: "What you want versus what's available creates friction. Desire feels sharper.",
    ...
    trine: {
      Venus: {
        title: "Harmony flows",
        observation: "Relationships, beauty, and comfort feel aligned. Appreciation comes easily.",
        choicePoint: "Tell someone what you appreciate about them.",
      },
      Mars: {
        title: "Balanced desire",
        observation: "What you want and what you're willing to do for it align. Action feels romantic.",
        choicePoint: "Make a move toward something you want.",
      },
      Ascendant: {
        title: "Naturally magnetic",
        observation: "You exude warmth without effort. Good day for social or romantic situations.",
    ...
    opposition: {
      Venus: {
        ...
        observation: "What you want from others reflects back what you're not giving yourself.",
        choicePoint: "Give yourself the thing you keep waiting to receive.",
      },
      Mars: {
        title: "Tension between love and will",
        observation: "What you want and what others want may clash. Compromise requires effort.",
        choicePoint: "Find the overlap instead of the difference.",
      },
      Ascendant: {
        title: "Relationship projection",
        observation: "What you attract shows you something about yourself. It's information, not judgment.",
    ...
    sextile: {
      Venus: {
        ...
        observation: "Small pleasures feel satisfying. Relationships have a gentle positive quality.",
        choicePoint: "Accept the compliment. Receive the nice thing.",
      },
      Mars: {
        title: "Graceful action",
        observation: "What you want and what you do align softly. Progress feels pleasant.",
  ...
  Mars: {
    conjunction: {
      Mars: {
        ...
        observation: "Your drive, anger, and desire reset. What you're willing to fight for becomes clearer.",
        choicePoint: "Start something that requires courage.",
      },
      Sun: {
        title: "Willpower surge",
        observation: "Your sense of purpose is energized. Confidence rises, possibly with impatience.",
        choicePoint: "Act on what you know you need to do.",
      },
      Ascendant: {
        title: "Visible assertiveness",
        observation: "You come across as direct, possibly intense. Others respond to your energy.",
    ...
    square: {
      ...
      Ascendant: {
        ...
        observation: "You may feel at odds with your surroundings or come across too strong.",
    ...
    opposition: {
      Mars: {
        ...
        observation: "Competition or conflict with others may arise. It's clarifying, not just difficult.",
        choicePoint: "Stand your ground without escalating.",
      },
      Sun: {
        title: "Push against ego",
        observation: "What you're trying to do meets resistance from who you think you should be.",
    ...
    sextile: {
      Mars: {
        title: "Gentle drive",
        observation: "Energy is available without urgency. You can act without forcing.",
  ...
  Mercury: {
    conjunction: {
      Mercury: {
        ...
        observation: "Your communication style resets. How you think and express yourself becomes clearer.",
        choicePoint: "Write something that articulates who you are now.",
      },
      Moon: {
        title: "Words meet feelings",
        observation: "Thoughts and emotions blend. Good for journaling, conversations that matter.",
        choicePoint: "Say how you actually feel, not just what you think.",
      },
      Ascendant: {
        title: "Communication is visible",
        observation: "Your ideas and words carry extra weight. Others notice what you say.",
    ...
    square: {
      ...
      Moon: {
        ...
        observation: "Logic and emotion argue. Overthinking emotional situations is likely.",
    ...
    trine: {
      ...
      Ascendant: {
        ...
        observation: "Communication comes across as intended. Good for important conversations.",
    ...
    opposition: {
      Mercury: {
        ...
        observation: "Your thinking meets opposing viewpoints. It's useful friction.",
        choicePoint: "Listen to understand, not to respond.",
      },
      Moon: {
        title: "Logic vs. instinct",
        observation: "What you think and what you feel are at odds. Both have truth.",
        choicePoint: "Honor both. Don't force one to win.",
      },
      Ascendant: {
        title: "Ideas meet resistance",
        observation: "Your communication may be questioned. Others see it differently.",
    ...
    sextile: {
      Mercury: {
        title: "Easy thinking",
        observation: "Mental processes flow gently. Light problem-solving works well.",
        choicePoint: "Handle the admin you've been avoiding.",
      },
      Moon: {
        title: "Soft understanding",
        observation: "Thoughts and feelings cooperate. Emotional conversations have ease.",
  ...
  Sun: {
    conjunction: {
      ...
      Moon: {
        ...
        observation: "Conscious and unconscious align. Seeds planted now have power.",
    ...
    trine: {
      ...
      Moon: {
        title: "Inner harmony",
        observation: "What you want and what you need align. Authentic expression feels easy.",
    ...
    opposition: {
      Sun: {
        ...
        observation: "Who you were versus who you're becoming is highlighted.",
        choicePoint: "Honor what you're growing into, not just what you've been.",
      },
      Moon: {
        title: "Full Moon personal",
        observation: "Needs and identity are at a peak. Something wants acknowledgment.",
...
export class DailyInsightEngine {
  ...
  private static calculateTimeline(
    ...
    if (hasMoonOnly) {
      ...
      longerCycleNote = 'Saturn moves slowly — this theme has been building and will continue for a while.';
    } else if (hasJupiter) {
   ...
   */
  private static getTransitingPositions(
    date: Date,
    natalChart: NatalChart
  ...
  private static computeAllSignals(
    ...
    const transitPlanets = ['Moon', 'Sun', 'Mercury', 'Venus', 'Mars'];
    ...
    for (const tPlanet of transitPlanets) {
      ...
      const maxOrb = ORB_CONFIG[tPlanet as keyof typeof ORB_CONFIG] || 3;
      ...
      for (const nTarget of natalTargets) {
        ...
        for (const asp of aspects) {
          ...
          if (orb <= effectiveMaxOrb) {
            ...
            // Determine domain
            let domain: LifeDomain = PLANET_TO_DOMAIN[nTarget] || PLANET_TO_DOMAIN[tPlanet] || 'mood';
  ...
  private static getTemplate(signal: TransitSignal): TransitTemplate | null {
    ...
    if (!planetTemplates) return null;

    const aspectTemplates = planetTemplates[signal.aspectType];
    if (!aspectTemplates) return null;
  ...
  private static generateHeadline(
    ...
    if (template) {
      return {
        main: template.title,
        subtext: `${signal.transitingPlanet} ${signal.aspectType} your ${signal.natalTarget} (${signal.orb.toFixed(1)}° orb)`,
      };
    }
