import { buildDailyAggregation, energyToNum, stressToNum, clamp } from '../dailyAggregates';
...
describe('daily aggregate builder', () => {
  ...
  describe('buildDailyAggregation()', () => {
    it('returns result for empty input', () => {
      const result = buildDailyAggregation({
        checkIns: [],
        journalEntries: [],
        chart: null,
        todayContext: null,
