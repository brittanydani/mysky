 ...
 * Sources: Jungian symbolism, somatic psychology, relationship-pattern theory, common dream research.
 *
...
export const DREAM_KEYWORDS: DreamKeywordEntry[] = [
  ...
  },
  {
    ...
    meaning: 'A wolf may represent instinct, loyalty, a perceived threat, or a wild, untamed part of your inner world.',
    category: 'animals',
  },
  {
    id: 'bear',
  ...
  },
  {
    ...
    meaning: 'Rabbits may reflect vulnerability, fertility, worry, or the urge to flee from something uncomfortable.',
    category: 'animals',
  },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    meaning: 'Teeth falling out is one of the most common dream symbols — it often reflects worry about self-image, communication, loss of control, or fear of aging.',
    category: 'body',
  },
  {
    id: 'hair',
  ...
  },
  {
    ...
    meaning: 'The heart in dreams often connects to emotional truth, love, vulnerability, or worry that makes itself known through the body.',
    category: 'body',
  },
  {
    id: 'breathing',
  ...
  {
    id: 'father',
    keywords: ['dad', 'father', 'daddy', 'papa', 'my dad', 'my father', 'stepdad', 'step dad', 'stepfather', 'step father', 'foster dad', 'foster father'],
  ...
  {
    id: 'adoptive_parent',
    keywords: ['adoptive dad', 'adoptive father', 'adoptive mom', 'adoptive mother', 'adoptive parent', 'adopted parent', 'adoptive family'],
    meaning: 'An adoptive parent appearing in a dream often touches on themes of belonging, chosen family, identity, and the complex emotional landscape of being raised by someone who is not biologically related — including questions about loyalty, gratitude, and where you truly fit.',
    category: 'people',
  },
  {
    id: 'ex_partner',
  ...
  },
  {
    ...
    meaning: 'A boss or authority figure may reflect your relationship with power, performance pressure, or how you feel about being evaluated.',
    category: 'people',
  },
  {
    id: 'friend',
  ...
  },
  {
    ...
    meaning: 'Crowds may reflect social pressure, a sense of being lost in the collective, or pressure from others’ expectations.',
    category: 'people',
  },
  {
    id: 'shadow_figure',
  ...
  },
  {
    ...
    meaning: 'School settings often reflect learning, testing, performance pressure, or revisiting a period when your identity was being shaped.',
    category: 'places',
  },
  {
    id: 'hospital',
  ...
  },
  {
    ...
    meaning: 'Sinking may reflect feeling weighed down by emotions, responsibilities, low mood, or a situation that feels inescapable.',
    category: 'movement',
  },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    meaning: 'A house often represents the self — different rooms may reflect different aspects of your inner world, memories, or emotional states.',
    category: 'buildings',
  },
  {
    id: 'hidden_room',
  ...
  },
  {
    ...
    meaning: 'Clocks and time pressure may reflect worry about deadlines, mortality, missed opportunities, or feeling like time is slipping away.',
    category: 'objects',
  },
  {
    id: 'knife',
  ...
  },
  {
    ...
    meaning: 'Stars may represent hope, guidance, aspiration, or the vast unknown that holds both wonder and uncertainty.',
    category: 'elements',
  },
  {
    id: 'earth_soil',
  ...
  },
  {
    ...
    meaning: 'Being unprepared for a test often reflects performance pressure, self-doubt, fear of being evaluated, or a situation where you feel unready.',
    category: 'scenarios',
  },
  {
    id: 'late',
    keywords: ['running late', 'going to be late', 'missed it', 'too late', 'late for', 'arrived late'],
    meaning: 'Being late often reflects worry about missing an opportunity, not meeting expectations, or the pressure of time.',
    category: 'scenarios',
  },
  {
    id: 'trapped',
  ...
  },
  {
    ...
    meaning: 'A wedding may represent commitment, union of different parts of yourself, a new beginning, or concern about a major life decision.',
    category: 'scenarios',
  },
  {
    id: 'funeral_dream',
  ...
  },
  {
    ...
    meaning: 'A plane crash may reflect the collapse of high ambitions, losing altitude on a goal, or fear about something major going wrong.',
    category: 'scenarios',
  },
  {
    id: 'discovering',
  ...
  },
  {
    ...
    meaning: 'Losing something important may reflect concern about security, identity, competence, or the fear that something meaningful is slipping away.',
    category: 'scenarios',
  },
  {
  ...
  {
    id: 'intimacy_dream',
    keywords: ['intimate', 'intimacy', 'sexual', 'sensual', 'making love', 'hooking up', 'physical closeness', 'desire to connect'],
    meaning: 'Intimacy in a dream may reflect longing for closeness, vulnerability, unprocessed desire, or the merging of different parts of yourself — it’s not always literal, but often points to what you want to let in or keep at a distance.',
    category: 'scenarios',
  },
  {
    ...
    meaning: 'A dream that ends without resolution often mirrors something in waking life that hasn’t fully settled — an open question, an unfinished conversation, or an emotional process that may still be working itself out.',
    category: 'scenarios',
  },
  {
    id: 'awkward_tension',
  ...
  {
    id: 'cant_find_way',
    keywords: ['couldn\'t find my way', 'lost my way', 'wrong turn', 'kept going in circles', 'going the wrong way', 'no sense of direction'],
    meaning: 'Not being able to find your way often reflects uncertainty about your direction in life, a decision that feels unclear, or the unease of feeling off-course.',
    category: 'scenarios',
  },
  {
    id: 'showing_up_wrong',
  ...
  {
    id: 'trying_to_call',
    keywords: ['tried to call', 'phone wouldn\'t work', 'couldn\'t dial', 'phone was dead', 'no signal', 'couldn\'t reach anyone', 'phone kept breaking'],
    meaning: 'Being unable to use a phone in a dream often reflects feeling cut off, unable to ask for help, or a breakdown in communication with someone important.',
    category: 'scenarios',
  },
  {
    id: 'cant_run',
  ...
  {
    id: 'natural_disaster',
    keywords: ['earthquake', 'tornado', 'hurricane', 'flood', 'wildfire', 'volcanic eruption', 'lava', 'the ground opened'],
    meaning: 'Natural disasters in dreams often reflect emotional overwhelm, sudden change, or forces in your life that feel beyond your control.',
    category: 'scenarios',
  },
  {
    id: 'being_invisible',
  ...
  {
    id: 'wrong_house',
    keywords: ['wrong house', 'not my house', 'house looked different', 'unfamiliar house', 'my house but different', 'house had changed'],
    meaning: 'Your house representing something unfamiliar may reflect shifts in your sense of self, identity changes, or the feeling that your inner landscape is rearranging.',
    category: 'scenarios',
  },
  {
    id: 'taking_care_of',
    keywords: ['taking care of', 'had to take care of', 'responsible for', 'looking after', 'caring for', 'babysitting'],
    meaning: 'Being responsible for someone or something in a dream may reflect caretaking patterns, emotional labor, or a part of yourself that needs tending.',
    category: 'scenarios',
  },
  {
    id: 'doors_locked',
  ...
  {
    id: 'old_home',
    keywords: ['childhood home', 'old house', 'grew up in', 'house I grew up in', 'my parents\' house', 'my old room', 'my old bedroom'],
    meaning: 'Your childhood home appearing in a dream often reflects foundational experiences, family dynamics, old emotional patterns, or the part of you shaped by those early years.',
    category: 'scenarios',
  },
  {
  ...
  },
  {
    ...
    meaning: 'Body changes in a dream often reflect shifting self-image, concern about health or aging, loss of control over your physical self, or a transformation that hasn’t been fully accepted.',
    category: 'scenarios',
  },
  ...
  },
  {
    ...
    meaning: 'Dreaming of the future may reflect anticipation, concern about what’s ahead, hopes, or the mind rehearsing possibilities.',
    category: 'time',
  },
  {
    id: 'night',
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    meaning: 'An angel may reflect guidance, protection, higher wisdom, or a messenger from deeper layers of your inner world.',
    category: 'spiritual',
  },
  {
    id: 'demon',
  ...
  },
  {
    ...
    meaning: 'Physical pain in a dream often reflects emotional pain, unresolved stress, or the body’s way of communicating distress.',
    category: 'perception',
  },
  {
    id: 'silence',
  ...
  },
  {
    ...
    meaning: 'Protecting someone may reflect your nurturing instincts, a desire to control outcomes, or concern about someone’s safety.',
    category: 'relationships',
  },
  {
    id: 'betrayal_act',
  ...
  },
  {
    ...
    meaning: 'Feeling abandoned may reflect fear of being left, or the echo of times when support wasn’t there when you needed it.',
    category: 'relationships',
  },
  {
    id: 'chasing_someone',
  ...
  },
  {
    ...
    meaning: 'Holding something or someone may reflect connection, responsibility, the emotional weight you carry, or a refusal to release what no longer serves.',
    category: 'relationships',
  },
  {
    id: 'rejection',
    keywords: ['rejected', 'rejection', 'pushed away', 'turned down', 'shut me out', 'didn\'t want me'],
    meaning: 'Rejection in a dream may reflect fear of not being enough, old wounds around belonging, or the pain of being turned away by someone or something that matters.',
    category: 'relationships',
  },
  {
  ...
  {
    id: 'someone_angry_at_me',
    keywords: ['angry at me', 'mad at me', 'disappointed in me', 'yelled at me', 'screamed at me', 'scolded me'],
    meaning: 'Someone being angry at you may reflect guilt, the expectation of punishment, internalized criticism, or unresolved tension in that relationship.',
    category: 'relationships',
  },
  {
    id: 'comforting_someone',
    keywords: ['comforted', 'consoled', 'calmed them down', 'held them while they cried', 'told them it would be okay'],
    meaning: 'Comforting someone in a dream may reflect your nurturing instincts, a desire to fix or heal, or a projection of your own need for comfort.',
    category: 'relationships',
  },
  {
