...
export const DEEPER_SKY_FEATURES: DeeperSkyFeature[] = [
  ...
  },
  {
    ...
    name: 'Pattern Depth',
    icon: 'analytics',
    description: 'Full stellium narratives and conjunction clusters',
    freeVersion: 'One stellium overview in your chart',
    premiumVersion: 'All stelliums with full narratives, element closers, retrograde notes, and conjunction cluster details',
    isPremium: true,
    bullets: [
      'Full stellium narratives and annotations',
      'All emphasis areas revealed',
