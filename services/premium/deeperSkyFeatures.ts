...
export const DEEPER_SKY_FEATURES: DeeperSkyFeature[] = [
  ...
  },
  {
    ...
    description: 'Full backup & restore for your account data',
    freeVersion: 'Not available',
    premiumVersion: 'Backup & restore — export a .msky file and import it on another device',
    isPremium: true,
    bullets: [
      'Backup & restore across devices',
      'Portable .msky export file',
