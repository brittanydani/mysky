...
const journalContents = [
  ...
  'Fresh start energy without the pressure of grand plans. Just sat with my coffee and thought about what I actually want — not the version I think I should want. The list was shorter than expected and more honest.',
  'This stretch has a particular heaviness to it I always underestimate. The days blur together. I\'m trying not to fight that but just let it be what it is. It will lift.',
  'Not depressed — just bluish. The middle of a heavy stretch has a specific undulation I\'ve learned to expect but still have to move through.',
  ...
  'Halfway through the week. Things are okay. Not spectacular — okay. And I\'m learning that okay is an underrated state that deserves more appreciation.',
  ...
  'A new week is here. I always find the middle stretch harder than the beginning. Less novelty, momentum still building. I\'m preparing to be patient with it.',
  ...
  'Bought myself flowers today. The gesture was partly ironic and partly not at all. Both things can be true.',
  ...
  'Deep in a quiet stretch and I\'m letting it be. Less pressure to produce, more permission to be quiet. The slower pace is an excuse and I\'m using it.',
  ...
  'Morning pages — the ritual of writing before my brain gets distracted. Three pages of loose thoughts, no editing. Processed a worry that had been sitting at the edge of my mind. Already feel better.',
